...
_REQUIRED_TRIGGERS = (
    ...
    "enforce_enrollment_course_company_insert",
    "enforce_enrollment_course_company_update",
    "enforce_lesson_progress_course_company_insert",
    "enforce_lesson_progress_course_company_update",
    "enforce_quiz_attempt_course_company_insert",
    "enforce_quiz_attempt_course_company_update",
    "enforce_practical_attempt_course_company_insert",
    "enforce_practical_attempt_course_company_update",
    "enforce_knowledge_chunk_document_company_insert",
    "enforce_knowledge_chunk_document_company_update",
